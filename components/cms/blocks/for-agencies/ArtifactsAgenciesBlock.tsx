...
export function ArtifactsAgenciesBlockComponent({ block, locale }: Props) {
  ...
  return (
    <section
      dir={rtl ? 'rtl' : 'ltr'}
      className={cn('py-20 lg:py-28', !isArabic && 'bg-secondary/30')}
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className={cn(isArabic ? 'mt-14' : '', 'grid sm:grid-cols-2 lg:grid-cols-3 gap-6')}>
              ...
              >
                ...
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center mb-4">
                  <Icon
                    className={cn(
                      'h-5 w-5',
                      isArabic ? 'text-foreground/70' : 'text-foreground',
                    )}
                  />
                </div>
